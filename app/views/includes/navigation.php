        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
            <div class="container-fluid">
                ...
                <a class="navbar-brand waves-effect" href="admin.php" style="font-size: 14px;" target="_blank">
                    <strong class="dark-text">HEALTHMART PHARMACY</strong>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="btn btn-sm btn-danger waves-effect" data-toggle="modal"
                                data-target="#add_supplier">Add Supplier</a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-sm btn-danger waves-effect" data-toggle="modal"
                                data-target="#add_customer">Add Customer</a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-sm btn-danger waves-effect" data-toggle="modal"
                        ...
                        <li class="nav-item">
                            <a class="btn btn-sm btn-danger waves-effect" data-toggle="modal"
                                data-target="#add_expenditure">Add Expenditure</a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-sm btn-danger waves-effect" data-toggle="modal"
                                data-target="#genStock">Generate Stock</a>
                        </li>
                        <?php elseif($grpid == 2): ?>
                        <li class="nav-item">
                            <a class="btn btn-sm btn-danger waves-effect" data-toggle="modal"
                    ...
                    <ul class="navbar-nav mr-auto">
                        <a type="button" class="nav-link btn btn-outline-danger btn-sm waves-effect" data-toggle="modal"
                            data-target="#change_password">Reset Password</a>
...
# ************************************************************ -->
        ...
        <div class="sidebar-fixed position-fixed">
            ...
            <div class="row waves-effect">
                <div class="col-md-4">
                    <img src="/public/img/avatar3.png" class="img-fluid float-left rounded"
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="checkst.php"
                    class="list-group-item <?php echo $stocks;?> list-group-item-action waves-effect"><i
                        class="fa fa-suitcase mr-3"></i>Stock Page
                </a>
                <a href="print_item.php"
                    class="list-group-item <?php echo $print_item;?> list-group-item-action waves-effect"><i
                        class="fa fa-suitcase mr-3"></i>Print Page
                </a>
                <a href="checksale.php"
                    class="list-group-item <?php echo $sales;?> list-group-item-action waves-effect"><i
                        class="fa fa-table mr-3"></i>View Sale List
                </a>
                <a href="delivery.php"
                    class="list-group-item <?php echo $delivery;?> list-group-item-action waves-effect"><i
                        class="fa fa-truck mr-3"></i>View Due Deliveries</a>
                <a href="checkbrand.php"
                    class="list-group-item <?php echo $brands;?> list-group-item-action waves-effect">
                    <i class="fa fa-list mr-3"></i>View Products List</a>
                <a href="checksuppliers.php"
                    class="list-group-item <?php echo $suppliers;?> list-group-item-action waves-effect">
                    <i class="fa fa-cart-plus mr-3"></i>View Suppliers List</a>
                <a href="checkusers.php"
                    class="list-group-item <?php echo $users;?> list-group-item-action waves-effect">
                    <i class="fa fa-users mr-3"></i>View Users List</a>
                <a href="checkcustomers.php"
                    class="list-group-item <?php echo $customers;?> list-group-item-action waves-effect">
                    <i class="fa fa-shopping-cart mr-3"></i>View Customer List
                </a>
                <a href="checkexpenses.php"
                    class="list-group-item <?php echo $expenses;?> list-group-item-action waves-effect">
                    <i class="fa fa-shopping-cart mr-3"></i>Expenses Page
                </a>
                <a href="report_page.php"
                    class="list-group-item <?php echo $report;?> list-group-item-action waves-effect">
                    <i class="fa fa-list mr-3"></i>Report Page
                </a>
                <a href="check_attendance.php"
                    class="list-group-item <?php echo $attendance;?> list-group-item-action waves-effect">
                    <i class="fa fa-list mr-3"></i>Check Attendance
                </a>
                <a href="allcash.php" class="list-group-item <?php echo $cashst;?> list-group-item-action waves-effect">
                    <i class="fa fa-shopping-cart mr-3"></i>Cash Analysis
                </a>
                <a href="allstocks.php"
                    class="list-group-item <?php echo $allstocks;?> list-group-item-action waves-effect">
                    <i class="fa fa-list mr-3"></i>All Stocks
                </a>
                <?php elseif($grpid == 2): ?>
                <a href="index.php" class="list-group-item <?php echo $stocks;?> list-group-item-action waves-effect"><i
                        class="fa fa-suitcase mr-3"></i>Sell Page
                </a>
                <!-- <a href="stock_statement.php"
                    class="list-group-item <?php echo $stocks_stat;?> list-group-item-action waves-effect">
                    <i class="fa fa-list mr-3"></i>Stock Statement
                ...
                <a href="/users/logout.php" class="list-group-item list-group-item-action waves-effect"><i
                        class="fa fa-lock mr-3"></i>Logout</a>
            </div>
        </div>
