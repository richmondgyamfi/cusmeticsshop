                ...
                foreach ($stdata as $key):
                 ?>
                                    <tr>
                                        ...
                                        <td>GH&#8373; <?=$key->totalpm; ?></td>
                                        <td><?=$key->soldby; ?></td>
                                        <td><?=$key->subdate; ?></td>
                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                data-target=".return" data-id="<?=$key->main_id;?>"
                                                data-sta_id="<?=$key->st_id;?>" data-entry="sales_tb"
                                                data-toggle="tooltip" data-placement="right" title="Sale On Return"><i
                                                    class="fa fa-reply"></i></button>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target=".delete" data-id="<?=$key->main_id;?>"
                                                data-entry="sales_tb" data-toggle="tooltip" data-placement="right"
                                                title="Delete Sale"><i class="fa fa-trash"></i></button>
